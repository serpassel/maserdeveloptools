...
public class ProvinceDialogPresenter extends ChooserPresenter<ProvincieModel> {

    //CONSTRUCTORS________________________________
    public ProvinceDialogPresenter(@NonNull Context context) {
        this(context, false);
    }

    public ProvinceDialogPresenter(@NonNull Context context, int viewlayout) {
        this(context, viewlayout, false);
    }

    public ProvinceDialogPresenter(@NonNull Context context, int viewlayout, boolean multiselect_flag) {
        super(context,viewlayout);
        setMultiselect_flag(multiselect_flag);
    }

    public ProvinceDialogPresenter(@NonNull Context context, boolean multiselect_flag) {
        super(context);
        setMultiselect_flag(multiselect_flag);
    }
