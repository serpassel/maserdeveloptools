...
public class TextViewBA {
    ...
    public static void setFontStyle(TextView view, String fontname) {
        Typeface type = Typeface.createFromAsset(view.getContext().getAssets(), "fonts/" + fontname);
    ...
    @BindingAdapter({"masked"})
    public static void masked(EditText view, String mask) {
        view.addTextChangedListener(new MaskWatcher(mask));
    }

    @BindingAdapter("android:onEditorAction")
    public static void setOnEditorActionListener(TextView view, TextView.OnEditorActionListener onEditorActionListener) {
    ...
    public static void setTextWatcher(TextView view, final BeforeTextChanged before,
        ...
        final TextWatcher oldValue = ListenerUtil.trackListener(view, newValue, id.textWatcher);
        if (oldValue != null) {
