...
import static es.marser.backgroundtools.enums.EventsExtras.*;
...
public class SimpleGestureFilter extends GestureDetector.SimpleOnGestureListener {
        ...
        private EventsExtras mode      = MODE_DYNAMIC;
        ...
        public void setMode(EventsExtras m){
            this.mode = m;
        }

        public EventsExtras getMode(){
            return this.mode;
        }
