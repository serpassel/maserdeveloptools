...
@Deprecated
public abstract class BaseDialogBinDecrep
        extends BaseDialog
     ...
     */
    public BaseDialogBinDecrep setTitle(String msg) {
     ...
     * @return clase actual [EN]  current class
     */
    public BaseDialogBinDecrep setBody(String msg) {
