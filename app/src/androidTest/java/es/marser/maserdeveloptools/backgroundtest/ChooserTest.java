    ...
    public void dialog1() {
        mActivityRule.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                BaseDialog bd1;
                //1
                bd1 =  DialogExample.provincieMultiChooser(mActivityRule.getActivity());
    ...
    public void dialog2() {
        mActivityRule.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                BaseDialog bd2;
                //2
                bd2 =  DialogExample.arabaVillagesChooser(mActivityRule.getActivity());
    ...
    public void dialog3() {
        mActivityRule.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                BaseDialog bd3;
                //3
                bd3 =  DialogExample.autonomousChooser(mActivityRule.getActivity());
